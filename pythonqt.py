...
from PyQt5.QtWidgets import QWidget, QApplication, QAction, qApp, QMainWindow, QMenu, QFileDialog, QHBoxLayout, QVBoxLayout
...
class Canvas( QWidget ):
    ...
    def mouseMoveEvent( self, event ):
        text = 'x: {0}, y: {1}'.format(event.x(), event.y())
        self.parentWidget().statusBar().showMessage( text )
